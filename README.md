...
```bash
git clone https://github.com/shibkari/react-components-project.git
cd my-react-app
npm install
npm run dev
```
...
#### 1️⃣ Stateful Functional Component (Counter)
...
#### 2️⃣ Stateful Class Component (Timer)
...
#### 3️⃣ Stateless Component (UserCard)
...
Кожен компонент виконує одну задачу і робить це добре.

✔️ **Reusability**  
Компоненти легко використовувати повторно в інших частинах додатку.

✔️ **Separation of Concerns**  
Логіка, UI та стилі поділені.

✔️ **Композиція замість наслідування**  
React побудований навколо композиції компонентів.

## 🏗️ Можливості для розширення
